...
function sp_boardNews($parameters, $id, $return_parameters = false)
{
	...
	echo '<div class="cat_bar" style = "margin-right: 45%;"><h3 class="catbg"> <i class="fa fa-bullhorn"></i> Latest News</h3></div>';
...
/*
	STYLE BORDER 
			...
			echo '
					...
					echo '
						<div', empty($style['body']['class']) ? '' : ' style="max-width:560px; background:rgba(0, 0, 0, 0.75); margin:10px auto; padding:10px 0px 20px 0px; border:1px solid #111; border-radius:4px; box-shadow:0px 4px 5px rgba(0, 0, 0, 0.75);"', '>';

   max-width:200px; background:rgba(0, 0, 0, 0.75); margin:40px auto; padding:10px 0px 20px 0px; border:1px solid #111; border-radius:4px; box-shadow:0px 4px 5px rgba(0, 0, 0, 0.75);

*/
			echo '
						<div', empty($style['body']['class']) ? '' : ' style=""', '>';
/* QUA */
			echo '
							<div class="sp_content_padding" style = "margin-top: 4%;"', '>';
			...
			if ($avatars && $news['avatar']['name'] !== null && !empty($news['avatar']['href']))
				echo '<hr>
								...
								<div class="middletext"><small><p align="right">', $news['time'], ',', ' ', $news['poster']['link'], $news['replies'], ' ', 'comments', '</p></small></div>';
			else
				echo '<div class="middletext" style = "margin-bottom: 0%;"> 


						<head><link href="https://fonts.googleapis.com/css?family=Lato:300" rel="stylesheet"></head>
						<h3 style = "color: #e2e2e2; font-size: 18px; font-weight: bold; font-family: Lato, sans-serif;">
						<a href="', $news['href'], '">', $news['subject'], '</a></h3>


				 <hr><p align = "right"><small style = "font-size: 11px;"><i class="fa fa-calendar"></i> ', $news['time'], ' ', '<i class="fa fa-fire"></i>  <strong>', $news['poster']['link'], '</strong> <i class="fa fa-comments-o"></i> ', $news['replies'], ' ', 'Comments', '</p></small></div>';
...
*/
	echo'
		...
		<a href="index.php?board=2.0" class="defbutton" style = "margin-left: 1%; margin-top: 2%;"><i class="fa fa-comments-o"></i>Go to the news thread</a>
		<BR/>
	';
/*
	<BR/>
	...
	<div class = "tehe">
		<div class="wrappor">
		  	<div id = "asd">
		  		<form>
		  			<asd class="button" onclick="window.location.href = "/index.php?board=2.0";><h3 style = "text-decoration: none;">View more news post</h3></asd>
		  			<asd class="button"; button onclick= "window.location.href = "https://w3docs.com";>Click Here</button>
		  		</form>
		  	</div>
		</div>
	</div>
